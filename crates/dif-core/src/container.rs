//! DIF v3 container: the theme-aware palette-indexed image and the lossless
//! `indexed_from_rgba8` builder. Dark-theme synthesis lives in `crate::regional`
//! and `crate::derive`.
