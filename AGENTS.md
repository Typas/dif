...
- Before claiming done, run `just ci` command to test all and check coverage. The test coverage should be 100% on functions and at least 80% on lines. If any python-related code has been modified, run `just py-ci` command to ensure.
